...
const ProductInfoBox = ({ className, title, children }) => {
    return (
        <div className={`product-${className} bg-white -mx-4 px-4 mb-6 overflow-hidden shadow-[0_1px_0_0_#e6e6e6]`}>
            <div className={`product-${className}__title mb-3 py-3 flex items-center gap-x-3 border-b border-gray-200 leading-5`}>
